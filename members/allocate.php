...
echo("<h4>Add Credits To Your Websites</h4>");
...
echo("<p><b>Add Credits To Your Webites:</b><br>
You have <b><font color=#ff0000>$credits</font></b> available credits for use.<br>");

echo("<table width=98% border=0 cellpadding=2 style=\"margin-left:10px;\">
<form action=$self_url" . "members/ method=post><input type=hidden name=fform value=allocate>
<tr style=\"background-color: #4DA0C6\">
<td align=center><b><font color=#FFFFFF>Webite Name</font></td>
<td align=center><b><font color=#FFFFFF>Test URL</font></td>
<td align=center><b><font color=#FFFFFF>Current Credits</font></td>
<td align=center><b><font color=#FFFFFF>Add Credits</td>
</tr>");
...
<td align=center><input type=text size=5 name=$name value=0 class=webforms></td></tr>");
}
echo("<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td align=right><b>Add Credits:</b></td>
<td align=center><input type=image src=images/add.gif border=0 alt=\"Add Credits\"></td></tr></form></table></p>");
